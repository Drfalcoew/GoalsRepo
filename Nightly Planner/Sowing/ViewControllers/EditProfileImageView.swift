...
class EditProfileImageView : UIViewController {
    ...
    let chartView : RankChartView = {
        let view = RankChartView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.layer.masksToBounds = true
        return view
    }()
    ...
    let descriptionLbl : UILabel = {
        ...
        lbl.numberOfLines = 0
        //lbl.text = "Complete your goals to rank up!"
        return lbl
    }()
...
//            tableView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.8),
            ...
            chartView.centerXAnchor.constraint(equalTo: self.view.centerXAnchor, constant: 0),
            chartView.widthAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 1),
            chartView.heightAnchor.constraint(equalTo: self.view.heightAnchor, multiplier: 1/2.3),
            chartView.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -40),
            
            descriptionLbl.centerXAnchor.constraint(equalTo: self.chartView.centerXAnchor, constant: 0),
            descriptionLbl.widthAnchor.constraint(equalTo: self.view.widthAnchor, multiplier: 0.8),
            descriptionLbl.heightAnchor.constraint(equalTo: self.descriptionLbl.widthAnchor, multiplier: 1/5),
            descriptionLbl.bottomAnchor.constraint(equalTo: self.chartView.topAnchor, constant: -5),
