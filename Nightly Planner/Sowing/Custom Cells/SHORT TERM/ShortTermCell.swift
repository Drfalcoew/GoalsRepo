...
class ShortTermCell: UICollectionViewCell {
  ...
  /*  override var isSelected: Bool {
    ...
    func setupViews() {
        ...
        self.titleView.addSubview(routineImage)
    ...
    func setupConstraints() {
        ...
        routineImage.topAnchor.constraint(equalTo: self.titleView.topAnchor, constant: 10).isActive = true
        routineImage.heightAnchor.constraint(equalTo: self.titleView.heightAnchor, multiplier: 0.3).isActive = true
        routineImage.rightAnchor.constraint(equalTo: self.titleView.rightAnchor, constant: -20).isActive = true
        routineImage.widthAnchor.constraint(equalTo: self.routineImage.heightAnchor, multiplier: 1).isActive = true
        ...
        titleLabel.rightAnchor.constraint(equalTo: self.routineImage.leftAnchor, constant: -10).isActive = true
