...
class ShowMenu: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate {
    ...
    let vc : [UIViewController] = [ViewController(), FocusViewController(), ProfileViewController()]
    ...
    @objc func settingsHandler() {
        ...
        if let window = UIApplication.shared.keyWindow {
            ...
            UIView.animate(withDuration: 0.5, delay: 0.0, options: .curveEaseIn, animations: {
                ...
                self.image.tintImageColor(color: UIColor(r: 40, g: 43, b: 53))
            }
        }
    }
    
    func setupConstraints() {
        settingsView.bottomAnchor.constraint(equalTo: self.menuView.bottomAnchor, constant: -30).isActive = true
