//
//  CreateLongCell.swift
//  Nightly Planner
//
//  Created by Drew Foster on 4/8/19.
...
class CreateLongCell: UICollectionViewCell {
    ...
    let goalTextField : UITextField = {
        ...
        view.placeholder = "Long term title"
    ...
    func setupConstraints() {
        self.addGoal.layer.cornerRadius = self.frame.height * 0.5 / 2
